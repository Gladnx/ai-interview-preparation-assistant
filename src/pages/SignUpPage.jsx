  ...
  return (
    <div style={{ minHeight: '100vh', display: 'flex', background: '#05050a' }}>
      ...
      <div className="auth-panel" style={{
        ...
        <div style={{ position: 'relative', padding: '48px', display: 'flex', flexDirection: 'column', justifyContent: 'space-between', height: '100%' }}>
      ...
      <div style={{
        ...
        <div style={{ width: '100%', maxWidth: 420 }}>
          <div style={{ display: 'flex', justifyContent: 'center', marginBottom: 36 }} className="mobile-logo">
            <Link to="/" style={{ display: 'flex', alignItems: 'center', gap: 10, textDecoration: 'none' }}>
              <div style={{
                width: 36, height: 36, borderRadius: 10,
                background: 'linear-gradient(135deg, #3b82f6, #2563eb)',
          ...
          <p style={{ marginTop: 16, color: '#374151', fontSize: 12, textAlign: 'center', lineHeight: 1.6 }}>
          ...
          <div style={{ marginTop: 24, textAlign: 'center', color: '#4b5563', fontSize: 14 }}>
            Already have an account?{' '}
            <Link to="/sign-in" style={{ color: '#3b82f6', fontWeight: 600, textDecoration: 'none' }}>
              Sign in
            </Link>
          </div>
        </div>
